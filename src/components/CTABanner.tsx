        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <p className="text-base md:text-lg opacity-90 mb-6 leading-relaxed max-w-md">
              Service rapide, sécurisé et abordable pour envoyer vos colis vers toutes les grandes
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                to="/colis"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#FF6B00] text-white rounded-full font-bold text-sm shadow-lg hover:bg-[#E05E00] hover:shadow-xl transition-all hover:-translate-y-0.5"
              >
                Envoyer un colis <ArrowRight size={16} />
              </Link>
              <Link
                to="/suivi"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white/20 backdrop-blur-sm text-white rounded-full font-bold text-sm hover:bg-white/30 transition-all border border-white/30"
              >
                Suivre un colis
              </Link>
            </div>
          ...
          <div className="relative hidden md:block">
            <div className="relative w-full aspect-square max-w-sm mx-auto">
              ...
              <div
                className="absolute top-0 right-8 bg-white rounded-2xl p-3 shadow-xl animate-pulse-soft"
                style={{ animationDelay: '0.2s' }}
              >
                <Truck size={28} className="text-[#FF6B00]" />
              </div>
              <div
                className="absolute bottom-8 left-0 bg-white rounded-2xl p-3 shadow-xl animate-pulse-soft"
                style={{ animationDelay: '0.4s' }}
              >
                <MapPin size={28} className="text-[#00A651]" />
              </div>
              <div
                className="absolute top-12 left-0 bg-[#FF6B00] rounded-2xl p-3 shadow-xl animate-pulse-soft"
                style={{ animationDelay: '0.6s' }}
              >
                <Shield size={28} className="text-white" />
              </div>
              <div
                className="absolute bottom-0 right-0 bg-[#00A651] rounded-2xl p-3 shadow-xl animate-pulse-soft"
