...
const footerColumns: Record<string, Array<{ label: string; to: string }>> = {
  ...
  Livrer: [
    ...
    { label: 'Devenir livreur', to: '/auth/register/driver' },
            ...
            <div className="flex items-center gap-2 mt-5">
              {socials.map((social, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-9 h-9 bg-gray-800 hover:bg-[#FF6B00] rounded-lg flex items-center justify-center transition-colors text-white"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 py-5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            <p className="text-xs text-gray-500">
              © 2026 AfriZone. Tous droits réservés. Fait avec{' '}
              <span className="text-[#FF6B00]">♥</span> en Afrique.
            </p>
